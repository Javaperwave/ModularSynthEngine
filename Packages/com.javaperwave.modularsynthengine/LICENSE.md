...
Required Notice: Copyright (c) 2026 Javier Balenzategui García (https://github.com/Javaperwave)

This license applies to the entire contents of this repository ("the
software"), including the audio engine and the optional UI, scenes, prefabs,
and related assets.
